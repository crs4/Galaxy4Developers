...
![Docker_logo]({{ste.url}}/images/06_docker_logo.png)
...
![Docker_client]({{ste.url}}/images/06_docker_command.png)
...
![Docker_data_volume]({{ste.url}}/images/06_docker_run_volume.png)
...
Build docker image:
```
$ docker buildi -t my_nginx_image --no-cache .
```
...
$ docker ps
CONTAINER ID        IMAGE                     COMMAND              CREATED             STATUS              PORTS                                                                   NAMES
4db632cef579        bgruening/galaxy-stable   "/usr/bin/startup"   15 seconds ago      Up 15 seconds       443/tcp, 8800/tcp, 0.0.0.0:80->80/tcp, 9002/tcp, 0.0.0.0:8021->21/tcp   nostalgic_agnesi

$ docker exec -it nostalgic_agnesi bash
root@4db632cef579:/galaxy-central# startup
```

![docker_galaxy]({{ste.url}}/images/06_docker_galaxy.png)
...
- Add Data
- [Become an Admin](http://bgruening.github.io/docker-galaxy-stable/users-passwords.html)
- Restart Galaxy
